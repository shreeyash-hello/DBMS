...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="logout1.php"><input type="submit" class="btnlogout" name="patsub1" onclick="return checklen();" value="logout"/></a>
      </li>
       <li class="nav-item">
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <form class="form-group" action="doctorsearch.php" method="post">
        ...
        <div class="col-md-2"><input type="submit" name="doctor_search_submit"  value="Search"></div></div>
      </form>
    </div>
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <form class="form-group" action="patientsearch.php" method="post">
        ...
        <div class="col-md-2"><input type="submit" name="patient_search_submit"  value="Search"></div></div>
      </form>
    </div>
      ...
      <form class="form-group" action="appsearch.php" method="post">
        ...
        <div class="col-md-2"><input type="submit" name="app_search_submit"  value="Search"></div></div>
      </form>
    </div>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <input type="submit" name="docsub" value="Add Doctor" >
        </form>
      </div>
      ...
      <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <input type="submit" name="docsub1" value="Delete Doctor"  onclick="confirm('do you really want to delete?')">
        </form>
      </div>
      ...
      <form class="form-group" action="messearch.php" method="post">
        ...
        <div class="col-md-2"><input type="submit" name="mes_search_submit"  value="Search"></div></div>
      </form>
    </div>
