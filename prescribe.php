...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="logout1.php"><input type="submit" class="btnRegister" name="patsub1" onclick="return checklen();" value="Logout"/></a>
        
      </li>
       <li class="nav-item">
       <a class="nav-link" href="doctor-panel.php"><input type="submit" class="btnRegister" name="patsub1" onclick="return checklen();" value="Back"/></a>
      </li>
    </ul>
  </div>
</nav>
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          ...
          <div class="row">
                  ...
                  <br><br><br><br>
          <input type="submit" name="prescribe" value="Prescribe" style="margin-left: 40pc;">
